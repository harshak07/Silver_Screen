...
public class ticket {
	...
	public void initialize()  {
		...
		printbutton.addActionListener(new ActionListener() {
			...
			public void sales() {
				...
				try {
					...
					for(int i=0;i<table.getRowCount();i++)
					{
						accounts=(String)table.getValueAt(i,0);
						name=(String)table.getValueAt(i,1);
						num=(String)table.getValueAt(i,2);
						movies=(String)table.getValueAt(i,3);
						times=(String)table.getValueAt(i,4);
						dates=(String)table.getValueAt(i,5);
						tickettype=(String)table.getValueAt(i,6);
						price=(int)table.getValueAt(i, 7);
						quantity=(int)table.getValueAt(i, 8);
						total=(int)table.getValueAt(i, 9);
		...
		lblNewLabel_4.setBounds(582, 354, 204, 21);
		...
		lblNewLabel_6.setBounds(10, 479, 474, 13);
